...
from agents.tools.agent_tools import rag_summarize, get_weather, get_user_location, rag
...
class RecommendAgent:
    ...
    def execute_stream(self, messages: list[dict], exclude: list[str] | None = None):
        rag.set_exclude(exclude)
