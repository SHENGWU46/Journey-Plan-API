from agents.utils.config_handler import prompts_conf
from agents.utils.path_tool import get_abs_path
from agents.utils.logger_handler import logger

def load_recommend_prompts():
    try:
        system_prompt_path = get_abs_path(prompts_conf["recommend_prompt_path"])
    except KeyError as e:
        logger.error(f"[load_recommend_prompts]在yaml配置项中没有recommend_prompt_path配置项")
        raise e
